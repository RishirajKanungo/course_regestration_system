...
<body id="top-of-content">
    ...
    <nav class="navbar navbar-expand-lg fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand js-scroll-trigger" href="#home"><img src="./images/logo.png"></a>
                    ...
                    <li class="nav-item">
                        ...
                        <?php
                            if (isset($_POST['reset'])) {
                                $script_path = '/home/ead/sp20DBp1-clout_computing/public_html/clout_computing/';
                                $command = "mysql --user={$dbuser} --password='{$dbpass}' " . "-h {$host} -D {$dbname} < {$script_path}";
                                $output = shell_exec($command . '/application.sql');
                            }         
                        ?>
                    </li>
                    <li class="nav-item">
      ...
      // Look up and verify the username and password in the database
        ...
        if ($data || $rec_data) {
            ...
            // if the login corresponds to a recommender 
                ...
                ?>
                    <script type="text/javascript">
                    window.location.href = '../recommender.php';
                    </script>
                <?php
            }
            else { ?>
